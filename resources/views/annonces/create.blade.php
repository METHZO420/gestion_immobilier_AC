...
<div class="container py-5">
    <h2 class="mb-4 text-2xl font-bold text-gray-700">Ajouter une annonce</h2>

    <form action="{{ route('annonces.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
